...
from api.routers.admin_event_sources import router as admin_event_sources_router
...
from api.routers.admin_chat import router as admin_chat_router
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://turkspot.onrender.com",  # Render frontend deployment (subdomain)
        "https://turkspot.app",  # Render frontend deployment (custom domain)
    ],
...
api_v1_router.include_router(admin_event_sources_router)
