...
CREATE TABLE IF NOT EXISTS ai_config (
    ...
    news_diaspora_min_score FLOAT NOT NULL DEFAULT 0.75,
    news_nl_min_score FLOAT NOT NULL DEFAULT 0.75,
    news_tr_min_score FLOAT NOT NULL DEFAULT 0.75,
    news_local_min_score FLOAT NOT NULL DEFAULT 0.70,
    news_origin_min_score FLOAT NOT NULL DEFAULT 0.70,
    news_geo_min_score FLOAT NOT NULL DEFAULT 0.80,
...
ALTER TABLE ai_config
    ...
    ADD CONSTRAINT ai_config_news_diaspora_min_score_range CHECK (news_diaspora_min_score >= 0.0 AND news_diaspora_min_score <= 1.0),
    ADD CONSTRAINT ai_config_news_nl_min_score_range CHECK (news_nl_min_score >= 0.0 AND news_nl_min_score <= 1.0),
    ADD CONSTRAINT ai_config_news_tr_min_score_range CHECK (news_tr_min_score >= 0.0 AND news_tr_min_score <= 1.0),
    ADD CONSTRAINT ai_config_news_local_min_score_range CHECK (news_local_min_score >= 0.0 AND news_local_min_score <= 1.0),
    ADD CONSTRAINT ai_config_news_origin_min_score_range CHECK (news_origin_min_score >= 0.0 AND news_origin_min_score <= 1.0),
    ADD CONSTRAINT ai_config_news_geo_min_score_range CHECK (news_geo_min_score >= 0.0 AND news_geo_min_score <= 1.0),
...
COMMENT ON COLUMN ai_config.news_diaspora_min_score IS 'Minimum relevance score for diaspora news feed (0.0-1.0)';
COMMENT ON COLUMN ai_config.news_nl_min_score IS 'Minimum relevance score for NL news feed (0.0-1.0)';
COMMENT ON COLUMN ai_config.news_tr_min_score IS 'Minimum relevance score for TR news feed (0.0-1.0)';
COMMENT ON COLUMN ai_config.news_local_min_score IS 'Minimum relevance score for local NL feed (0.0-1.0)';
COMMENT ON COLUMN ai_config.news_origin_min_score IS 'Minimum relevance score for origin feed (0.0-1.0)';
COMMENT ON COLUMN ai_config.news_geo_min_score IS 'Minimum relevance score for geopolitics feed (0.0-1.0)';
