...
DEFAULT_TIMEOUT_S = int(os.getenv("OVERPASS_TIMEOUT_S", "60"))
DEFAULT_MAX_RESULTS = int(os.getenv("DISCOVERY_MAX_RESULTS", "50"))
DEFAULT_RATE_LIMIT_QPS = float(os.getenv("DISCOVERY_RATE_LIMIT_QPS", "0.08"))
DEFAULT_SLEEP_BASE_S = float(os.getenv("DISCOVERY_SLEEP_BASE_S", "7.0"))
DEFAULT_SLEEP_JITTER_PCT = float(os.getenv("DISCOVERY_SLEEP_JITTER_PCT", "0.40"))
